...
|---|---|---:|---:|---:|---:|---:|
| anthropic | `claude-haiku-4-5,claude-sonnet-4-6` | 37 | 95.9 | 9 | n/a* | 5619192 |
| deepseek | `deepseek-chat` | 28 | 91.9 | 12 | $0.0478 | 8237222 |
| gemini | `gemini-2.5-flash,gemini-2.5-pro` | 37 | 72.6 | 57 | n/a* | 7845891 |
| llama | `meta-llama/llama-3.3-70b-instruct` | 36 | 93.5 | 13 | $0.2266 | 9239685 |
| mistral | `mistral-large-2411,mistral-small-2506` | 37 | 99.0 | 2 | $0.4731 | 13501752 |
| openai | `gpt-4.1-mini,gpt-4.1` | 37 | 97.6 | 5 | $0.5162 | 10229907 |
...
| `event-based gateway()` | 13.9 | 2 (llama, openai) | 36 |
| `parallel gateway()` | 11.1 | 2 (gemini, llama) | 36 |
| `script task()` | 8.6 | 2 (anthropic, gemini) | 35 |
| `escalation boundary event()` | 5.7 | 2 (anthropic, gemini) | 35 |
| `event subprocess()` | 5.6 | 2 (gemini, mistral) | 36 |
| `intermediate message throw()` | 5.6 | 2 (gemini, llama) | 36 |
| `timer boundary event()` | 5.6 | 2 (gemini, mistral) | 36 |
...
| `call activity()` | 4.3 | 1 (gemini) | 23 |
| `embedded subprocess()` | 2.9 | 1 (gemini) | 35 |
| `exclusive gateway with default branch()` | 2.9 | 1 (gemini) | 35 |
| `parallel multi-instance activity()` | 2.9 | 1 (gemini) | 35 |
| `send task()` | 2.9 | 1 (gemini) | 35 |
| `error end()` | 2.8 | 1 (gemini) | 36 |
...
|---|---|---|---:|---:|---:|---:|
| anthropic | ProcessInputAssessment | `claude-haiku-4-5` | 1130631 | 935094 | 429 | 217 |
| anthropic | ValidatedProcessContract | `claude-sonnet-4-6` | 1849856 | 392650 | 424 | 217 |
...
| gemini | ProcessInputAssessment | `gemini-2.5-flash` | 1048623 | 771882 | 426 | 208 |
| gemini | ValidatedProcessContract | `gemini-2.5-pro` | 5155058 | 301354 | 308 | 208 |
...
| mistral | ProcessInputAssessment | `mistral-small-2506` | 3043116 | 1556328 | 1308 | 200 |
| mistral | ValidatedProcessContract | `mistral-large-2411` | 7027620 | 405324 | 442 | 200 |
| openai | ProcessInputAssessment | `gpt-4.1-mini` | 1051815 | 631557 | 474 | 212 |
| openai | ValidatedProcessContract | `gpt-4.1` | 7189834 | 301160 | 468 | 212 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| anthropic | 0 | 5.2 | 5 | 8 | 14 | 1.4 | 217 |
| deepseek | 5 | 6.7 | 5 | 14 | 23 | 3.4 | 148 |
| gemini | 0 | 4.2 | 5 | 8 | 20 | 3.1 | 208 |
| llama | 5 | 5.7 | 5 | 9 | 15 | 1.5 | 200 |
| mistral | 5 | 10.8 | 8 | 29 | 69 | 9.4 | 200 |
| openai | 5 | 5.9 | 5 | 10 | 23 | 2.4 | 212 |
